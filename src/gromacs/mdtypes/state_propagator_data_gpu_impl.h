...
public:
    ...
    //! \copydoc StatePropagatorDataGpu::setFReducedOnDeviceEventExpectedConsumptionCount
    void setFReducedOnDeviceEventExpectedConsumptionCount(AtomLocality atomLocality,
                                                           int          expectedConsumptionCount);
