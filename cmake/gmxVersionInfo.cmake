...
set(REGRESSIONTEST_MD5SUM "280e3aaf5c7e65a200035ad7e45bd6e3" CACHE INTERNAL "MD5 sum of the regressiontests tarball for this GROMACS version")
...
set(GMX_VERSION_STRING_OF_FORK "Gamd-v1.1" CACHE INTERNAL
    "Version string for forks of GROMACS to set to describe themselves" FORCE)
...
if (GMX_VERSION_STRING_OF_FORK)
    ...
    set(GMX_MANUAL_DOI_INTERNAL "10.5281/zenodo.17671776") # Set correct doi string here
    set(GMX_SOURCE_DOI_INTERNAL "10.5281/zenodo.17671793") # Set correct doi string here
endif()
